...
class TripViewModel : BaseViewModel() {
    ...
    init {
        initTripList.add(Trip("21:00","28.02.2022", "23", "Сидячий", "Алматы - Нурсултан", "7", "20", "Автовокзал Алматы",  2000.0))
        initTripList.add(Trip("21:00","28.02.2022", "23", "Сидячий", "Алматы - Нурсултан", "7", "20", "Автовокзал Алматы",  5000.0))
